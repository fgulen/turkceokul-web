...
const ETKINLIK_LABELS: Record<string, string> = {
  ...
  CoktanSecmeliBoslukDoldurma: 'Çoktan Seçmeli Boşluk Doldurma',
  ResimSesEslestirme: 'Resim–Ses Eşleştirme',
  OkuGec: 'Oku & Geç',
  BoslukDoldurma: 'Boşluk Doldurma',
  MetinDogruYanlis: 'Metin Doğru / Yanlış',
  MetinCheckBox: 'Cevapları İşaretle',
  ResimMetinEslestirmeDogruYanlis: 'Resim–Metin Doğru / Yanlış',
  ResimSesEslestirmeDogruYanlis: 'Resim–Ses Doğru / Yanlış',
  MetinSesEslestirmeDogruYanlis: 'Metin–Ses Doğru / Yanlış',
  ...
  ResimliSoruCevap: 'Resimli Soru-Cevap',
