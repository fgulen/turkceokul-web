...
import { cn, toMediaUrl, diyalogMetinClass, metniSatirlara } from '@/lib/utils';
  ...
  return (
    <div className="max-w-sm md:max-w-lg mx-auto">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <p className={cn('text-2xl font-bold flex-1', diyalogMetinClass(current.description) ?? 'text-center')}>{metniSatirlara(current.description)}</p>
          {sesUrl && (
            <button
