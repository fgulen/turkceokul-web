...
export function KelimelerdenCumleYapPlayer({ etkinlik, onComplete }: PlayerProps) {
  ...
  const correctWords = useMemo(
    () => (current.description ?? '').split(/\s+/).filter(Boolean),
    [current],
  );
  ...
  return (
    <div className="max-w-lg md:max-w-2xl mx-auto">
      ...
      <ActivityHint>Kelimelere sırayla tıklayarak cümleyi kur</ActivityHint>
