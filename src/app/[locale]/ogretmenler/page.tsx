...
const plans = [
  {
    ...
    color: '#414751',
    features: ['Sınırsız öğretmen & öğrenci', 'Ünite 1 ücretsiz', 'Okuma kitapları: PDF ücretsiz', 'AI Stüdyo: 5 üretim/ay (Quiz + Kahoot)', 'Canlı Kahoot modu', 'QR katılım'],
  ...
  },
  {
    ...
    color: '#1b75bc',
    features: ['Sınırsız sınıf & öğrenci', 'AI İçerik Stüdyosu', 'Okuma kitapları: etkileşimli etkinlikler', 'Canlı Kahoot modu', 'Excel rapor indirme', 'Tam analitik paneli', '10 öğrenci lisansı dahil'],
    missing: [],
    cta: 'Ücretsiz Dene',
